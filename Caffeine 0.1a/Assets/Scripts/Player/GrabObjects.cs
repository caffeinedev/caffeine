...
namespace Player
{
	...
	public class PickedUpObjectEvent : GameEvent
	{
		public GameObject obj;

		public PickedUpObjectEvent (GameObject o)
		{
			name	= "PickedUpObjectEvent";
			obj		= o;
		}
	}

	public class PushObjectEvent : GameEvent
	{
		public GameObject obj;

		public PushObjectEvent (GameObject o)
		{
			name = "PushObjectEvent";
			obj = o;
		}
	}

	public class DroppedObjectEvent : GameEvent
	{
		public GameObject obj;

		public DroppedObjectEvent (GameObject o)
		{
			name = "DroppedObjectEvent";
			obj = o;
		}
	}
	...
	public class GrabObjects : MonoBehaviour
	{
		...
		[Range(10f,1000f)]
		public float pushBreakForce = 45, pushBreakTorque = 45;
		...
		private void DropPushable ()
		{
			...
			EventManager.Instance.Send (new DroppedObjectEvent (heldObj));
