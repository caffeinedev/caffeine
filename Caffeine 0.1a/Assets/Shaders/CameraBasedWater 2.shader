...
////// Emissive:
                ...
                float3 node_8503 = ((0.5*dot(normalDirection,lightDirection)+0.5*viewReflectDirection*viewDirection)*1.0+0.0);
                float node_3537 = 2.0;
                float node_3865 = 2.0;
