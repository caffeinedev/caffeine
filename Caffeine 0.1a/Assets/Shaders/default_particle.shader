...
Shader "Shader Forge/default_particle" {
    Properties {
        ...
        _node_8129 ("node_8129", Range(0.1, 10)) = 3.484616
...
////// Lighting:
                float attenuation = LIGHT_ATTENUATION(i);
                float node_5434 = 2.0;
                float3 finalColor = (floor(clamp(clamp(pow(1.0-max(0,dot(normalDirection, viewDirection)),_node_8129),0,0.9),0.1,0.5) * node_5434) / (node_5434 - 1)*_LightColor0.rgb*_GlossColor.rgb);
