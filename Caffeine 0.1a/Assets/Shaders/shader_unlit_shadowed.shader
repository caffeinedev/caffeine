...
////// Emissive:
                ...
                float node_5726 = (1.0-max(0,dot(normalDirection, viewDirection)));
                float3 finalColor = emissive + (clamp(node_5726,0.1,0.2)*_LightColor0.rgb);
...
////// Lighting:
                float attenuation = LIGHT_ATTENUATION(i);
                float node_5726 = (1.0-max(0,dot(normalDirection, viewDirection)));
                float3 finalColor = (clamp(node_5726,0.1,0.2)*_LightColor0.rgb);
